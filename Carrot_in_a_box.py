...
print(playerNames)
print()
print(p1Name + ', you have a RED box in front fo you.')
print(p2Name + ', you have a GOLD box in front fo you.')
print()
...
print()
print(p2Name + ', say one of the following sentences to ' + p2Name + '.')
